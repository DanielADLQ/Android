...
class MiAdaptadorRecyclerAsis (var asistentes : ArrayList<Asistente>, var  context: Context, var ev:Evento) : RecyclerView.Adapter<MiAdaptadorRecyclerAsis.ViewHolder>() {
    ...
    class ViewHolder(view: View) : RecyclerView.ViewHolder(view) {
        ...
        fun bind(
            ...
            itemView.setOnClickListener(
                ...
                {
                    if (pos == MiAdaptadorRecyclerAsis.seleccionado) {
                        MiAdaptadorRecyclerAsis.seleccionado = -1
                    } else {
                        MiAdaptadorRecyclerAsis.seleccionado = pos
                    }
            ...
            itemView.setOnLongClickListener(View.OnLongClickListener {
                ...
                dialogo.setPositiveButton("Expulsar",
                    DialogInterface.OnClickListener { dialog, which ->


                        ev.asistentes.removeAt(pos)

                        db.collection("eventos").document(ev.id).update("asistentes",ev.asistentes)

                        //miAdaptadorRecycler.asistentes.removeAt(pos)
                        miAdaptadorRecycler.notifyDataSetChanged()
                ...
                dialogo.setTitle("Expulsar asistente")
                dialogo.setMessage("¿Desea expulsar a este asistente?")
                dialogo.show()
