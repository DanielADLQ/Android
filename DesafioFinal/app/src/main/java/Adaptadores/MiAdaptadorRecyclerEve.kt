...
import com.example.desafiofinal.VentanaModAsist
import com.google.firebase.firestore.ktx.firestore
import com.google.firebase.ktx.Firebase

class MiAdaptadorRecyclerEve (var eventos : ArrayList<Evento>, var  context: Context) : RecyclerView.Adapter<MiAdaptadorRecyclerEve.ViewHolder>() {
    ...
    class ViewHolder(view: View) : RecyclerView.ViewHolder(view) {
        ...
        fun bind(
            ...
            context: Context,
            pos: Int,
            miAdaptadorRecycler: MiAdaptadorRecyclerEve
        ) {
            ...
            itemView.setOnClickListener(
                ...
                {
                    if (pos == MiAdaptadorRecyclerEve.seleccionado) {
                        MiAdaptadorRecyclerEve.seleccionado = -1
                    } else {
                        MiAdaptadorRecyclerEve.seleccionado = pos
                    }
                    ...
                    var intentV1 = Intent(context, VentanaModAsist::class.java)
