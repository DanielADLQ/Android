...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        */
        ...
        miRecyclerView = findViewById(R.id.recyclerUsers) as RecyclerView
    ...
    fun crearUnoAutomaticoConIndiceNoAleatorio(){
        ...
        val nota=random.nextInt(10)

        var user = hashMapOf(
            "first" to randomNombre,
            "last" to randomApellido,
            "age" to edadRandom,
            "notaEvaluacion" to nota
        )
        ...
        db.collection("animales")
            .document(1.toString())  //Si hubiera un campo duplicado, lo reemplaza.
            .set(animal)
            .addOnSuccessListener {
                Log.e(TAG, "Documento añadido.")
            }
