    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        botonValidar.setOnClickListener(){
            if(!esAnonimo.isChecked && nombre.text.length==0){
                ...
                Conexion.addPersona(this,
                    Encuestado(datoNombre,datoSO,esp,textoHoras.text.toString(),idNuevo)
                )
                ...
                esAnonimo.isChecked=false
                checkDam.isChecked=false
                checkAsir.isChecked=false
                checkDaw.isChecked=false
